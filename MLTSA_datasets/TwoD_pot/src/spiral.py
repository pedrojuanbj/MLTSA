...
class potential_spiral:
    ...
    def generate_function(self):
        ...
        r_symb = (spy.sin((angle_symb + self.warping_coeff * distance_squared_symb) * self.n_petals) * self.sinus_to_distance_coeff * distance_squared_symb + 2)
    ...
    def visualize_3d(self, ngrid=200):
        ...
        [x,y] = np.meshgrid(np.linspace(-self.BOUNDARY, self.BOUNDARY, ngrid),np.linspace(-self.BOUNDARY, self.BOUNDARY, ngrid))
    ...
    def expl_2b_potential(self, x, y):
        ...
        """
        return -(0.05*x**2 + 0.05*y**2 + 1)*np.exp(-1.02040816326531/(0.05*(x**2 + y**2)*np.sin(0.02*x**2 + 0.02*y**2 + 2*np.arctan2(x, y)) + 1)**2)
    ...
    def expl_2b_dx(self, x, y):
        ...
        """
        print("Function not accelerated by numba, only used for limited visualisation, to produce data pipeline please refer to other methods")
        return -0.1*x*exp(-1.02040816326531/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**2) - 1.02040816326531*(-0.2*x*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) - 2*(0.04*x + 2*y/(x**2 + y**2))*(0.05*x**2 + 0.05*y**2)*cos(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)))*(-0.05*x**2 - 0.05*y**2 - 1)*exp(-1.02040816326531/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**2)/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**3
    ...
    def expl_2b_dy(self, x, y):
        ...
        """
        print("Function not accelerated by numba, only used for limited visualisation, to produce data pipeline please refer to other methods")
        return -0.1*y*exp(-1.02040816326531/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**2) - 1.02040816326531*(-0.2*y*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) - 2*(0.05*x**2 + 0.05*y**2)*(-2*x/(x**2 + y**2) + 0.04*y)*cos(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)))*(-0.05*x**2 - 0.05*y**2 - 1)*exp(-1.02040816326531/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**2)/(0.05*(x**2 + y**2)*sin(0.02*x**2 + 0.02*y**2 + 2*atan2(x, y)) + 1)**3